...
\U1|s~0\ : maxv_lcell
-- Equation(s):
-- \U1|s~0_combout\ = (\a_in~combout\ $ (\c_in~combout\ $ (\b_in~combout\)))
...
\c_out~0\ : maxv_lcell
-- Equation(s):
-- \c_out~0_combout\ = ((\a_in~combout\ & ((\c_in~combout\) # (\b_in~combout\))) # (!\a_in~combout\ & (\c_in~combout\ & \b_in~combout\)))
